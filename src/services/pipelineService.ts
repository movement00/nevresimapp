...
export interface PipelineShot {
  ...
  textFirst: boolean;
  /** Which cropped region to prepend to references: "pillow" | "embroidery" | "edge" | undefined */
  focusRegion?: "pillow" | "embroidery" | "edge";
  enabled: boolean;
}
...
export async function runPipeline(
  ...
  // to references for detail shots so the model sees a zoomed-in view.
